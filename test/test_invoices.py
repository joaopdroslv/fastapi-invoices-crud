...
def test_create_invoice_to_an_especific_user():
    ...
    new_invoice = {'value': 1000.0, 'paid': False, 'payment_date': None, 'payment_method': None, 'user_id': created_user_id}
...
def test_create_invoice_to_a_nonexistent_user():
    ...
    new_invoice = {'value': 1000.0, 'paid': False, 'payment_date': None, 'payment_method': None, 'user_id': 9999}
...
def test_link_an_already_linked_invoice():
    ...
    first_new_user = {'first_name': 'Michael', 'last_name': 'Smith'}  # The invoice will be linked to this user at first
